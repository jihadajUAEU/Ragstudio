...
def test_modal_preprocessor_routes_content_list_once(tmp_path):
    ...
    assert chunks[0].source_location["page_start"] == 1
    assert chunks[0].source_location["page_end"] == 1
    assert chunks[1].metadata["page"] == 2
    assert chunks[1].source_location["page_start"] == 2
    assert chunks[1].source_location["page_end"] == 2
