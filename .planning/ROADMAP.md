...
- [ ] **Phase 1: Proof Contract and Baseline Packet** - Create the canonical public proof packet, schemas, claims registry, and safe baseline evidence.
...
|-------|----------------|--------|-----------|
| 1. Proof Contract and Baseline Packet | 0/3 | Not started | - |
